...
function GameServer() {
    ...
    this.config = {
        ...
        serverTracker: 1, // Set to 1 if you want to show your server on the tracker http://ogar.mivabe.nl/master (check that your server port is opened for external connections first!)
...
GameServer.prototype.start = function () {
    ...
    this.wsServer = new this.WebSocket.Server({ port: process.env.PORT});
